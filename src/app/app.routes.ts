...
import { EpisodesComponent } from '../app/pages/admin/episodes/episodes.component';
...
export const routes: Routes = [
  ...
  { 
    ...
    children: [
      ...
      { path: 'episodes', loadComponent: () => import('../app/pages/admin/episodes/episodes.component').then(m => m.EpisodesComponent) },
